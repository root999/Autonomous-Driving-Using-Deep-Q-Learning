...
class LogReward(Log):
    ...
    def __init__(self,checkpoint_base_dir):
        # These will be set in read() below.
        self.episode = None
        self.mean = None
        log_reward_path = os.path.join(checkpoint_base_dir, "log_reward.txt")
        # Super-class init.
...
class LogQValues(Log):
    ...
    def __init__(self,checkpoint_base_dir):
        ...
        self.max = None
        self.std = None
        log_q_values_path = os.path.join(checkpoint_base_dir, "log_q_values.txt")
        # Super-class init.
